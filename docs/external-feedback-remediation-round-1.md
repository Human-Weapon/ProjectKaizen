...
|---|---|---|---|
| EXT-PG-001 | Persistent decisions helped, but game-project traceability was used too sparsely. | DOCUMENTATION_GAP | DOCUMENTED: the existing memory graph, records, paths, relations, evidence, and bounded retrieval are shown in `PromptGraph/docs/traceability-game-example.md`. |
